...
export const useGetServices = () => {
  ...
  const deleteServiceHandler = async (id) => {
    try {
      ...
      const updatedServices = Object.keys(groupedServices).reduce(
        (acc, category) => {
          acc[category] = groupedServices[category].filter(
  ...
  const updateServiceHandler = async (
    ...
    try {
      ...
      const updatedService = Object.keys(groupedServices).reduce(
        (acc, category) => {
