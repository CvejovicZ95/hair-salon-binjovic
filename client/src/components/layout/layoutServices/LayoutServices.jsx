...
export const LayoutServices = () => {
  return (
    <div className="services" id="services">
      ...
      <div className="services-first-section">
        <div className="service">
          ...
          <div className="service-content">
            ...
            <p>
              Balayage is a French word meaning to sweep or to paint. It allows
              for a sun-kissed natural looking hair colour.
            </p>

            <Link to={"/reservation"}>
              <button onClick={scrollToTop} className="service-button">
                ZAKAŽI SVOJ TRETMAN
              </button>
            </Link>
          </div>
        ...
        <div className="service">
          ...
          <div className="service-content">
            ...
            <p>
              Bilo da želite da promenite dužinu, stil, šiške ili nešto drugo,
              naš tim će vam pomoći da pronađete izgled koji je savršen za vas.
            </p>
        ...
        <div className="service">
          ...
          <div className="service-content">
            ...
            <p>
              Za kosu bilo koje dužine i teksture, naši obučeni tim pruža
              neverovatne rezultate za savršen izgled nakon feniranja.
            </p>
      ...
      <Link to={"/services"}>
        <button className="prices-button" onClick={scrollToTop}>
